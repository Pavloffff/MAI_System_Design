...
EventCreateHandler::EventCreateHandler(
    ...
    eventService_(context.FindComponent<lab2::application::EventServiceComponent>().GetService())
{
}
    ...
    userver::server::request::RequestContext& context) const
{
    try {
        ...
        auto createEventDto = requestJson.As<lab2::events::CreateEventRequestBody>();
    ...
    userver::server::request::RequestContext& context) const
{
    try {
        ...
        lab2::domain::TalkId talkId = lab2::domain::TalkId(std::stoll(request.GetPathArg("talk_id")));
        lab2::domain::UserId tokenUserId = lab2::domain::UserId(std::stoll(context.GetData<std::string>("user_id")));
