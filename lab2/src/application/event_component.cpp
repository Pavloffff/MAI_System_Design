...
{
    auto eventRepo = context.FindComponent<lab2::infrastructure::EventRepositoryComponent>().GetRepository();
    ...
    eventService_ = std::make_shared<lab2::application::EventService>(eventRepo, talkRepo, userRepo);   
}

std::shared_ptr<lab2::application::EventService> EventServiceComponent::GetService() const
{
