    ...
    : LoggableComponentBase(config, context)
{
    ...
    userRepo_ = std::make_shared<lab4::infrastructure::MongoUserRepository>(
        mongo_uri);
}

std::shared_ptr<lab4::application::IUserRepository> UserRepositoryComponent::GetRepository() const
{
    return userRepo_;
}
