...
EventCreateHandler::EventCreateHandler(
    ...
    eventService_(context.FindComponent<lab4::application::EventServiceComponent>().GetService())
{
}
    ...
    userver::server::request::RequestContext& context) const
{
    try {
        ...
        auto createEventDto = requestJson.As<lab4::events::CreateEventRequestBody>();
    ...
    userver::server::request::RequestContext& context) const
{
    try {
        ...
        lab4::domain::EventId eventId = lab4::domain::EventId(std::stoll(request.GetPathArg("event_id")));
        lab4::domain::TalkId talkId = lab4::domain::TalkId(std::stoll(request.GetPathArg("talk_id")));
        lab4::domain::UserId tokenUserId = lab4::domain::UserId(std::stoll(context.GetData<std::string>("user_id")));
